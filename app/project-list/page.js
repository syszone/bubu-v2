                                            ...
                                            <div className="content-inner project-box-style3_wrapper" style={{ display: `${activeIndex == 1 ? "block" : "none"}` }}>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Codyfight IGO</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Shadow Fight 2</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Shadow Fight Arena</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Plants vs. Zombies™</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Street Fighter IV CE</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Ninja Ryuko: Shadow Ninja Game</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Quadropus Rampage</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>
                                                ...
                                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                                    <div className="header_project">
                                                        ...
                                                        <h5 className="heading"><Link href="/project-details">Sniper Honor: 3D Shooting Game</Link></h5>
                                                    </div>
                                                    <div className="content">
                                                        <div className="td td1">
                                                            <p>Total raise</p>

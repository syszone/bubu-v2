...
export default function ProjectGrid5() {
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <div className="project-wrapper mb30">
                                        <div className="image-wrapper" data-aos="fade-in" data-aos-duration={1000}>
                                            <img src="/assets/images/common/project_84.jpg" alt="" />
                                        </div>
                                ...
                                <div className="col-md-12">
                                    <div className="project-wrapper">
                                        <div className="image-wrapper" data-aos="fade-in" data-aos-duration={1000}>
                                            <img src="/assets/images/common/project_85.jpg" alt="" />
                                        </div>
                                        <div className="content-wrapper">
                                            <div className="content_inner" data-aos="fade-left" data-aos-duration={1200}>
                                                <div className="wrapper">
                                    ...
                                    <div className="project-box-style3_wrapper">
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                ...
                                                <h5 className="heading"><Link href="/project-details">Angry Birds 2</Link></h5>
                                            </div>
                                        ...
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                ...
                                                <h5 className="heading"><Link href="/project-details">AFK summoner fantasy hero war</Link></h5>
                                            </div>
                                            <div className="content">
                                                <div className="td td1">
                                                    <p>Min allocation</p>
                                        ...
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                <div className="image">
                                                    <img className="mask" src="/assets/images/common/project_86.png" alt="" />
                                                    <div className="shape">
                                                        <img src="/assets/images/common/shape_2.png" alt="" />
                                                    </div>
                                                </div>
                                                <h5 className="heading"><Link href="/project-details">Soul Knight</Link></h5>
                                            </div>
                                            <div className="content">
                                                <div className="td td1">
                                                    <p>Min allocation</p>
                                        ...
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                ...
                                                <h5 className="heading"><Link href="/project-details">Modern Combat 5: mobile FPS</Link></h5>
                                            </div>
                                            <div className="content">
                                                <div className="td td1">
                                                    <p>Min allocation</p>
                                        ...
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                ...
                                                <h5 className="heading"><Link href="/project-details">Shadow of Death: Dark Knight</Link></h5>
                                            </div>
                                            <div className="content">
                                                <div className="td td1">
                                                    <p>Min allocation</p>
                                        ...
                                        <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                            <div className="header_project">
                                                <div className="image">
                                                    <img className="mask" src="/assets/images/common/project_87.png" alt="" />
                                                    <div className="shape">
                                                        <img src="/assets/images/common/shape_2.png" alt="" />
                                                    </div>
                                                </div>
                                                <h5 className="heading"><Link href="/project-details">Honkai Impact 3</Link></h5>
                                            </div>
                                            <div className="content">
                                                <div className="td td1">
                                                    <p>Min allocation</p>

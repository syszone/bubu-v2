...
export default function ProjectGrid1() {
                                            ...
                                            <div className="content-inner project-box-style6_wrapper " style={{ display: `${activeIndex == 1 ? "flex" : "none"}` }}>
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_36.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                ...
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details" /></h5>
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_37.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_45.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_22.jpg" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_46.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">BladeBound: RPG Adven...</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_38.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_47.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Color Page ASMR</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_39.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_48.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Grimvalor</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_40.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_49.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Stickman Legends</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_41.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_50.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">ZingSpeed Mobile</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_42.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_51.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">LifeAfter</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_43.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_52.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Homeworld Mobile</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                ...
                                                <div className="project-box-style6">
                                                    ...
                                                    <div className="img-box">
                                                        <div className="image">
                                                            <img src="/assets/images/common/project_44.png" alt="" />
                                                        </div>
                                                        <div className="content">
                                                            <div className="img-box">
                                                                <div className="image_inner">
                                                                    <img className="mask" src="/assets/images/common/project_53.png" alt="" />
                                                                    <div className="shape">
                                                                        <img src="/assets/images/common/shape2.png" alt="" />
                                                                    </div>
                                                                </div>
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Dark Days: Zombie Survival</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                    ...
                                                    <div className="img-box">
                                                        ...
                                                        <div className="content">
                                                            <div className="img-box">
                                                                ...
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Modern Combat Versus</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                    ...
                                                    <div className="img-box">
                                                        ...
                                                        <div className="content">
                                                            <div className="img-box">
                                                                ...
                                                                <div className="content-inner">
                                                                    <h5 className="heading"><Link href="/project-details">Mini World: CREATA</Link></h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">
                                                    ...
                                                    <div className="img-box">
                                                        ...
                                                        <div className="content">
                                                            <div className="img-box">
                                                                ...
                                                                <div className="content-inner">
                                                                    <h5 className="heading">ZingSpeed Mobile</h5>
                                                                    <p className="desc">Ookeenga is the no.1 Vertical Multiplayer Real Time Strategy Game with breathtaking 3D visuals...</p>
                                                                </div>
                                                            </div>
                                                            <div className="content-bottom">

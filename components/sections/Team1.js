                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <div className="team-box-wrapper">
                                <div className="team-box" data-aos="fade-up" data-aos-delay={100} data-aos-duration={800}>
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Darrell Steward</Link></h5>
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={200} data-aos-duration={800}>
                                    <img className="shape" src="/assets/images/common/shape_3.png" alt="" />
                                    <img className="shape_ecfect" src="/assets/images/common/shape_4.svg" alt="" />
                                    <div className="image">
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Kristin Watson</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={300} data-aos-duration={800}>
                                    <img className="shape" src="/assets/images/common/shape_3.png" alt="" />
                                    <img className="shape_ecfect" src="/assets/images/common/shape_4.svg" alt="" />
                                    <div className="image">
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Jacob Jones</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={400} data-aos-duration={800}>
                                    <img className="shape" src="/assets/images/common/shape_3.png" alt="" />
                                    <img className="shape_ecfect" src="/assets/images/common/shape_4.svg" alt="" />
                                    <div className="image">
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Jane Cooper</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={100} data-aos-duration={800}>
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Jenny Wilson</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={200} data-aos-duration={800}>
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Dianne Russell</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={300} data-aos-duration={800}>
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Devon Lane</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">
                                ...
                                <div className="team-box" data-aos="fade-up" data-aos-delay={400} data-aos-duration={800}>
                                    ...
                                    <div className="content">
                                        <h5 className="name"><Link href="/team-details">Robert Fox</Link></h5>
                                        <p className="position">Senior Designer</p>
                                        <ul className="social">
                                            <li>
                                                <Link href="#">

                            ...
                            <div className="project-box-style3_wrapper">
                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                    <div className="header_project">
                                        ...
                                        <h5 className="heading"><Link href="/project-list">Zombie plant 2</Link></h5>
                                    </div>
                                ...
                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                    <div className="header_project">
                                        ...
                                        <h5 className="heading"><Link href="/project-list">Codyfight IGO</Link></h5>
                                    </div>
                                    <div className="content">
                                        <div className="td td1">
                                            <p>Total raise</p>
                                ...
                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                    <div className="header_project">
                                        <div className="image">
                                            <img className="mask" src="/assets/images/common/project_10.png" alt="" />
                                            <div className="shape">
                                                <img src="/assets/images/common/shape_2.png" alt="" />
                                            </div>
                                        </div>
                                        <h5 className="heading"><Link href="/project-list">Asphalt="" 9: Legends</Link></h5>
                                    </div>
                                    <div className="content">
                                        <div className="td td1">
                                            <p>Total raise</p>
                                ...
                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                    <div className="header_project">
                                        ...
                                        <h5 className="heading"><Link href="/project-list">Garena Free Fire MAX</Link></h5>
                                    </div>
                                    <div className="content">
                                        <div className="td td1">
                                            <p>Total raise</p>
                                ...
                                <div className="project-box-style3" data-aos="fade-in" data-aos-duration={800}>
                                    <div className="header_project">
                                        ...
                                        <h5 className="heading"><Link href="/project-list">Need for Speed™ No Limits</Link></h5>
                                    </div>
                                    <div className="content">
                                        <div className="td td1">
                                            <p>Total raise</p>
